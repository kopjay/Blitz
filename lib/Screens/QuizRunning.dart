...
class QuizRunning extends StatefulWidget {
  static String tag = '/QuizRunning';

  @override
  _QuizRunningState createState() => _QuizRunningState();
}

class _QuizRunningState extends State<QuizRunning> {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) => GestureDetector(
          onTap: () {
            setState(
              () {
                QuizDetails(index).launch(context);
              },
            );
          },
          child: Container(
