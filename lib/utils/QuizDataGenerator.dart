...
List<NewQuizModel> getQuizData() {
  ...
  model1.quizName = "Reading Strategy";
  model1.totalQuiz = "3 Quiz";
  ...
  model3.quizName = "Running Text";
  model3.totalQuiz = "3 Quiz";
...
List<QuizTestModel> quizGetData() {
  ...
  model1.heading = "Number";
  model1.image = quiz_ic_quiz1;
  model1.type = "Quiz 1";
  model1.description = "Lorem ipsum dolor sit amet consectetur.";
  model1.status = "true";

  QuizTestModel model2 = QuizTestModel();
  model2.heading = "Letter";
  model2.image = quiz_ic_quiz2;
  model2.type = "Quiz 2";
  model2.description = "Lorem ipsum dolor sit amet consectetur.";
  model2.status = "false";

  QuizTestModel model3 = QuizTestModel();
  model3.heading = "Words";
  model3.image = quiz_ic_quiz1;
  model3.type = "Quiz 3";
  model3.description = "Lorem ipsum dolor sit amet consectetur.";
  model3.status = "false";
